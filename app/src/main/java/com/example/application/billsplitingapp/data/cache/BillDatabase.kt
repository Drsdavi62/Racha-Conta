...
@Database(entities = [BillEntity::class, PersonEntity::class, ProductEntity::class, ProductWithPeopleEntity::class], version = 1)
...
abstract class BillDatabase: RoomDatabase() {
    ...
    abstract val productWithPeopleDao: ProductWithPeopleDao
